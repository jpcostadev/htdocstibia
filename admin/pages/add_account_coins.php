...
$title = 'Adicionar coins às contas';
...
$successMessage = getSession('admin_add_account_coins_success');
if ($successMessage !== false) {
    unsetSession('admin_add_account_coins_success');
...
if (isset($_POST['add_coins']) && $account_logged->isSuperAdmin()) {
    ...
    if ($coinsToAdd < 1) {
        ...
        try {
            ...
            setSession('admin_add_account_coins_success', "{$coinsToAdd} coins adicionadas a todas as contas.");
                            ...
                            <form action="<?= $base ?>" method="post">
                                <div class="form-group">
                                    <div class="input-group justify-content-between">
                                        ...
                                        <div>
                                            <label for="account-coin-type">Tipo de coin</label>
                                            <select id="account-coin-type" name="coin_type" class="form-select">
