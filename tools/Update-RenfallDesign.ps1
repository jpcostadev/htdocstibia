...
$files = @(
 ...
 'admin/pages/dashboard.php', 'admin/pages/add_account_coins.php', 'admin/pages/add_player_coins.php',
 'system/templates/admin.dashboard.html.twig', 'system/templates/admin.statistics.html.twig',
